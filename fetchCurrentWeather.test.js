...
test("fetchCurrentWeather follows type specification", async () => {
...
test("fetchCurrentWeather with incorrect input", async () => {
    const promise = fetchCurrentWeather(10000, -10000);
